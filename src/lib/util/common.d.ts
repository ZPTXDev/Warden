...
import type { ActionRowBuilder, AttachmentBuilder, AutocompleteInteraction, Client, Collection, EmbedBuilder, MessageActionRowComponentBuilder, TextChannel, VoiceChannel } from 'discord.js';
...
export type WardenInteraction<T> =
