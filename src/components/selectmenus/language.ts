import type { MessageOptionsBuilderInputs, MessageOptionsBuilderOptions, WardenInteraction } from '#src/lib/util/common.d.js';
...
export default {
	name: 'language',
	async execute(interaction: WardenInteraction<SelectMenuInteraction>): Promise<void> {
